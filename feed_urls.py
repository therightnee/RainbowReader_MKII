...
news_links = list([ 
    dict(source = "Google News", locate = "http://news.google.com/news?pz=1&cf=all&ned=us&hl=en&output=rss"), 
    dict(source = "RCP", locate = "http://feeds.feedburner.com/realclearpolitics/qlMj"),
    ...
    dict(source = "Economist", locate = "http://www.rssmix.com/u/3844187/rss.xml")
])
